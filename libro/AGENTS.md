# AGENTS.md — Manuale operativo del progetto "Frattura"
*Questo file viene caricato in automatico. È la mia bussola: dice dove vive cosa, come si lavora, cosa NON fare. **Copia sincronizzata di `CLAUDE.md`:** se ne modifichi uno, allinea l'altro.*
